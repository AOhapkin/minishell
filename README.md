...
- [ ] Основная часть
  ...
  - [ ] Двойные кавычки
    - [ ] Выполнить простую команду с аргументами, но в этот раз с кавычками (внутри кавычек должны быть пробелы)
    - [ ] Выполнить `echo "cat lol.c | cat>lol.c"`
    - [ ] Что-нибудь кроме `$`
  - [ ] Одинарные кавычки
    - [ ] Выполнить команду с одинарными кавычками как аргумент
    - [ ] Попробовать пустые аргументы
...
- [ ] CD 
  ...
  - [ ] `cd closed_dir` директория закрытая для доступа
    - должно быть ![img_11.png](img_11.png)
    - сейчас так ![img_12.png](img_12.png)
  - [ ] `cd .. < test.txt` или `cd .. > test.txt`
    - переходит на директорию выше
    - при `>` или `>>` гарантирован редирект
  - [ ] `cd .. | cat`  или `echo loh | cd ..`
    - не переходит на директорию выше
  - 
  - [ ] `unset HOME`
    - удаляет все значения или нет
  - [ ] `export HOME`
    - заменяет все значения или добавляет одно
![img_7.png](img_7.png)